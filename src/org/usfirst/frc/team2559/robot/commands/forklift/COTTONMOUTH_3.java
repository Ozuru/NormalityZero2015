 ...
 *
 */
public class COTTONMOUTH_3 extends Command {

	public COTTONMOUTH_3() {
	...
	protected void execute() {
		if (!(Robot._forkLift.isBotSwitch() || Robot._forkLift.isTopSwitch())) {
			if (Robot._PRISM.getCurrentLevel() < 3) {
				Robot._forkLift.setPulley(RobotMap.FORKLIFT_RAISE_SPEED);
			} else if (Robot._PRISM.getCurrentLevel() > 3) {
	...
	protected boolean isFinished() {
		return (Robot._forkLift.isBotSwitch() || Robot._forkLift.isTopSwitch() || Robot._PRISM.isLevel3());
	}
