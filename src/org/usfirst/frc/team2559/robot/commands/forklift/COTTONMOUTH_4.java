 ...
 *
 */
public class COTTONMOUTH_4 extends Command {

	public COTTONMOUTH_4() {
	...
	protected void execute() {
		if (!(Robot._forkLift.isBotSwitch() || Robot._forkLift.isTopSwitch())) {
			if (Robot._PRISM.getCurrentLevel() < 4) {
				Robot._forkLift.setPulley(RobotMap.FORKLIFT_RAISE_SPEED);
			} else if (Robot._PRISM.getCurrentLevel() > 4) {
	...
	protected boolean isFinished() {
		return (Robot._forkLift.isBotSwitch() || Robot._forkLift.isTopSwitch() || Robot._PRISM.isLevel4());
	}
