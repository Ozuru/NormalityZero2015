 ...
 *
 */
public class LoadFromFeeder extends CommandGroup {
    
    public  LoadFromFeeder() {
        // Add Commands here:
    	...
    	addParallel(new DriveForDistance(0.65, -12, false));
    	addSequential(new COTTONMOUTH_TIME(1000, true));
    	addParallel(new DriveForDistance(0.3, -6, false));
    	addSequential(new COTTONMOUTH_MIN());    	
    	}
}
